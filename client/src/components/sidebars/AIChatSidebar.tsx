...
For å aktivere AI-funksjoner, legg til OPENAI_API_KEY i miljøvariablene.`
  ...
  return (
    <div className="h-full flex flex-col bg-background sidebar-responsive gap-0">
      {/* Header */}
      ...
      {/* Input-område */}
      <div className="px-2 pb-1 pt-1 border-t border-border flex-shrink-0">
      ...
      <ScrollArea className="flex-1 overflow-hidden" ref={scrollAreaRef}>
        <div className="px-2">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-start text-center p-4 pt-2">
          ...
          <div className="space-y-2 chat-messages pb-2">
